...
\begin{song}
\songline{The raging rocks}
\songline{And shivering shocks}
\songline{Shall break the locks}
\songline{Of prison gates;}
\songline{And Phibbus' car}
\songline{Shall shine from far}
\songline{And make and mar}
\songline{The foolish Fates.}
\end{song}
