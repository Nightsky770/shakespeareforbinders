...
\enter{\textsc{Orlando} and \textsc{Adam}}
...
\begin{prose_speech}[Oliver] 
\stage{Threatening \textsc{Orlando}}  What, boy! 
 \end{prose_speech}

\begin{prose_speech}[Orlando] 
\stage{Holding off \textsc{Oliver} by the throat}  Come, come, elder brother, you are too young in this. 
 \end{prose_speech}
...
\begin{prose_speech}[Adam] 
\stage{Coming forward}  Sweet masters, be patient. For your father's remembrance, be at accord.
 \end{prose_speech}

\begin{prose_speech}[Oliver] 
\stage{To \textsc{Orlando}}  Let me go, I say. 
 \end{prose_speech}
...
\stage{\textsc{Orlando} releases \textsc{Oliver}}
...
\begin{prose_speech}[Oliver] 
\stage{To \textsc{Adam}}  Get you with him, you old dog. 
 \end{prose_speech}
...
\begin{prose_speech}[Adam] 
 ...
 \exit{\textsc{Orlando} and \textsc{Adam}}
