...
\begin{letter} %dropcap
	\begin{tikzpicture}[remember picture, overlay]
		\node (dropcap) at ($(current page.west)+(2.8cm,-5.25cm)$) {\includegraphics[width=0.125\linewidth]{3iiidropcapB}};
	\end{tikzpicture}
\end{letter}
\begin{a4} 
	\begin{tikzpicture}[remember picture, overlay]
		\node (dropcap) at ($(current page.west)+(3cm,-5.9cm)$) {\includegraphics[width=0.125\linewidth]{3iiidropcapB}};
	\end{tikzpicture}
\end{a4}
