...
\begin{letter} %dropcap
	\begin{tikzpicture}[remember picture, overlay]
		\node (dropcap) at ($(current page.west)+(2.25cm,-2.3cm)$) {\includegraphics[width=0.125\linewidth]{3idropcapT}};
	\end{tikzpicture}
\end{letter}

\begin{a4} %dropcap
	\begin{tikzpicture}[remember picture, overlay]
		\node (dropcap) at ($(current page.west)+(2.25cm,-1.2cm)$) {\includegraphics[width=0.12\linewidth]{3idropcapT}};
	\end{tikzpicture}
\end{a4}
