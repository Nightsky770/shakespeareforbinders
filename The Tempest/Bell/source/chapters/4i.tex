...
\begin{letter} %dropcap & first speech
	\begin{tikzpicture}[remember picture, overlay]
		\node (dropcap) at ($(current page.west)+(2.75cm,-2.25cm)$) {\includegraphics[width=0.125\linewidth]{4idropcapI}};
	\end{tikzpicture}
...
\begin{a4} %dropcap & first speech
	\begin{tikzpicture}[remember picture, overlay]
		\node (dropcap) at ($(current page.west)+(2.8cm,-2cm)$) {\includegraphics[width=0.125\linewidth]{4idropcapI}};
	\end{tikzpicture}
