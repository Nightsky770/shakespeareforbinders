...
\begin{letter} %dropcap
	\begin{tikzpicture}[remember picture, overlay]
		\node (dropcap) at ($(current page.west)+(2.25cm,-2.6cm)$) {\includegraphics[width=0.125\linewidth]{3iidropcapT}};
	\end{tikzpicture}
\end{letter}

\begin{a4} %dropcap
	\begin{tikzpicture}[remember picture, overlay]
		\node (dropcap) at ($(current page.west)+(2.5cm,-1.3cm)$) {\includegraphics[width=0.115\linewidth]{3iidropcapT}};
	\end{tikzpicture}
\end{a4}
