...
\begin{letter} %dropcap
	\begin{tikzpicture}[remember picture, overlay]
		\node (dropcap) at ($(current page.west)+(2.8cm,-5.5cm)$) {\includegraphics[width=0.125\linewidth]{5idropcapN}};
	\end{tikzpicture}
...
\begin{a4} %dropcap
	\begin{tikzpicture}[remember picture, overlay]
		\node (dropcap) at ($(current page.west)+(3cm,-3.9cm)$) {\includegraphics[width=0.125\linewidth]{5idropcapN}};
	\end{tikzpicture}
...
% \begin{figure}[tb]
% \centering
% \includegraphics[width=.4\textwidth]{5iplants}
% \end{figure}
% \end{a4}
