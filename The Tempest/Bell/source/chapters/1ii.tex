...
\begin{letter}
	\begin{tikzpicture}[remember picture, overlay]
		\node (dropcap) at ($(current page.west)+(2.15cm,-5.25cm)$) {\includegraphics[width=0.12\linewidth]{1iidropcapI}};
	\end{tikzpicture}
...
\begin{a4}
	\begin{tikzpicture}[remember picture, overlay]
		\node (dropcap) at ($(current page.west)+(2.4cm,-4.2cm)$) {\includegraphics[width=0.105\linewidth]{1iidropcapI}};
	\end{tikzpicture}
