...
\begin{letter}
	\begin{tikzpicture}[remember picture, overlay]
		\node (dropcap) at ($(current page.west)+(2.9cm,-5cm)$) {\includegraphics[width=0.125\linewidth]{2idropcapB}};
	\end{tikzpicture}
...
\begin{a4}
	\begin{tikzpicture}[remember picture, overlay]
		\node (dropcap) at ($(current page.west)+(3cm,-4.6cm)$) {\includegraphics[width=0.125\linewidth]{2idropcapB}};
	\end{tikzpicture}
