...
\begin{letter} % I'll kiss thy foot - letter
	\begin{colorbigpic}
		[\basicscale]
		{2ii_kissfoot}
		[<I'll kiss thy foot>]
...
\begin{a4} % I'll kiss thy foot - a4
	\begin{colorbigpic}
		[\basicscale]
		{2ii_kissfoot}
		[<I'll kiss thy foot>]
...
\exit{}
 ...
 \begin{letter}
	\vfill
	\centerline{\includegraphics[width=.4\linewidth]{tinybarrelrider}}
 \end{letter}
 
  \begin{a4}
	\vfill
	\centerline{\includegraphics[width=.3\linewidth]{tinybarrelrider}}
 \end{a4}